...
import com.luxoft.springel.example04.Country;
import com.luxoft.springel.example04.UsualPerson;

import java.util.List;
import java.util.ArrayList;

public class SpringELAnnotationBasedMethodInvocationTest {
	
	private static final String APPLICATION_CONTEXT_XML_FILE_NAME = "example04/application-context.xml";
